...
// Theme colors (premium astrology palette)
const COLORS = {
  navy: "#071426",
  navySoft: "#0C1930",
  slate: "#4C5C80",
...
export default function App() {
  ...
  const [incomingPermanentPrompt, setIncomingPermanentPrompt] = useState(false);
    ...
    sessionMetaUnsub.current = db
      ...
      .onSnapshot(
        (snap) => {
          ...
          if (!data.permanentAccepted && data.expiresAt && data.expiresAt.toMillis) {
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        >
          ...
          <View style={{ marginTop: 24, width: "70%", alignSelf: "center" }}>
            <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  homeBgImage: {
    resizeMode: "cover", // no opacity here so colors stay true
  },
  ...
  // Chat bubbles (premium style B)
  chatLeft: {
    alignSelf: "flex-start",
    backgroundColor: "rgba(9, 23, 52, 0.96)",
